...
const Home = () => {
    ...
    const getShoesData = async () => {
        const resp = await fetch("https://stockx.com/api/browse?productCategory=sneakers&sort=release_date&releaseTime=gte-" + Date.now().toLocaleString() + "&order=ASC&country=FR");
