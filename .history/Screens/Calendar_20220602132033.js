...
const Calendar = ({navigation}) => {
    return (
        ...
        renderDay={(day, item) => {
            return (
                <View style={{width: 40, height: 150, margin: 10, justifyContent: 'center', alignItems: 'center', borderColor: 'blue', borderWidth: 2}}>
                    <Text style={{fontSize: 18, fontWeight: 'bold'}}>{day.getDate()}</Text>
                </View>
            );
        }}
