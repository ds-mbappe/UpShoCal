...
const Calendar = ({navigation}) => {
    return (
        ...
        renderItem={(item, firstItemInDay) => {
            return (
                <View style={{justifyContent: 'center', alignItems: 'flex-start', borderColor: 'red', borderWidth: 3, margin: 10}}>
        ...
        renderDay={(day, item) => {
            return (
                <View style={{width: 30, margin: 10, borderColor: 'blue', borderWidth: 3}}>
